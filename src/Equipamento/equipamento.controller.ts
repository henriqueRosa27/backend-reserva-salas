...
import {EquipamentoValidation, altera_statusValidation } from './equipamento.validation';
...
export class EquipamentoController {
    ...
    @Post()
    async create(
        @Body(new ValidationPipe(EquipamentoValidation)) equipamento: EquipamentoEntity,
    ): Promise<EquipamentoEntity>{
